...
def question(screen, qtext, show_text=True, color=(255, 255, 255), background=(0, 0, 0)):
    ...
    BLACK = background
    WHITE = color
    button_list = [pygame.K_a, pygame.K_b, pygame.K_c, pygame.K_d, pygame.K_e, pygame.K_f, pygame.K_g, pygame.K_h,
                   ...
                   pygame.K_y, pygame.K_z, pygame.K_COMMA, pygame.K_0, pygame.K_1, pygame.K_2, pygame.K_3, pygame.K_4,
                   pygame.K_5, pygame.K_6, pygame.K_7, pygame.K_8, pygame.K_9, pygame.K_PERIOD, pygame.K_AT]
